...
extension StudyList {
    static let listPersonnelAptitude: [StudyList] = [ StudyList(category: "인/적성", title: "인적성 시험 대비 그룹참여자 구합니다.", imageName: "profile3", location: "송파구", date: "2/14(토)", member: "3/4"), StudyList(category: "인/적성", title: "취업을 위한 인사이트, 시사PT 스터디로 함께 나아가 봅시다!", imageName: "profile2", location: "동작구", date: "3/12(월)", member: "1/4"), StudyList(category: "인/적성", title: "취업을 위한 인사이트, 시사PT 스터디로 함께 나아가 봅시다!", imageName: "profile2", location: "동작구", date: "3/12(월)", member: "1/4"), StudyList(category: "인/적성", title: "산업의 트렌드와 기업의 전략을 공부하는 스터디, 참여자를 모집합니다", imageName: "profile4", location: "동작구", date: "3/12(월)", member: "1/4"), StudyList(category: "인/적성", title: "산업별 동향을 살피는 산업 기업 분석 스터디 참가자를 모집합니다", imageName: "profile5", location: "동작구", date: "3/12(월)", member: "1/4"), StudyList(category: "인/적성", title: "비즈니스 인사이트를 얻는 산업 기업 분석 스터디, 함께 할 동료를 찾습니다", imageName: "profile6", location: "동작구", date: "3/12(월)", member: "1/4") ]
}
